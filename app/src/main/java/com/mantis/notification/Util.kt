    ...
    companion object {
        ...
        fun createBaseNotificationBuilder(context: Context, notificationId: Int): Notification.Builder {
            ...
            val clickPendingIntent =
                PendingIntent.getService(context, 2, clickIntent, PendingIntent.FLAG_IMMUTABLE)
...
//            }, (2000).toLong()) // 2s后执行
        ...
        fun createMediaStyle(context: Context) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                val mPendingIntent = PendingIntent.getService(context, 1, mIntent, PendingIntent.FLAG_IMMUTABLE)
                val notificationId = generateNotificationId()
                val builder = createBaseNotificationBuilder(context, notificationId)
        ...
        fun createReplyStyleNotification(context: Context) {
            ...
            val mPendingIntent = PendingIntent.getService(context, 1, mIntent, PendingIntent.FLAG_MUTABLE)
